...
return [
    ...
    */
        ...
        'PA_override_visibility' => 'Person album visibility overrides the photo visibility',
        'PA_override_searchability' => 'Person album ignores the searchable flag of a person',
        'hide_nsfw_in_person_albums' => 'Do not show sensitive photos in Person Albums',
    ...
    'details' => [
        ...
        'hide_nsfw_in_smart_albums' => 'Pictures placed in sensitive albums will not be shown in Smart Albums.',
        'hide_nsfw_in_frame' => 'Pictures placed in sensitive albums will not be shown on the Frame.',
        'hide_nsfw_in_map' => 'Pictures placed in sensitive albums will not be shown on the Map.',
        'hide_nsfw_in_search' => 'Pictures placed in sensitive albums will not be shown in Search.',
        'search_photos_layout' => '',
        'hide_nsfw_in_rss' => 'Pictures placed in sensitive albums will not be shown in the RSS feed.',
        'hide_nsfw_in_timeline' => 'Pictures placed in sensitive albums will not be shown in the timeline page.',
